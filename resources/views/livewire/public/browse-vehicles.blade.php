            ...
            @forelse($vehicles as $vehicle)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="chaloo-slider relative">
                                ...
                                <div class="slider-track"
                                    ...
                                    @foreach($vehicle->images as $image)
                                        <div class="slider-slide" style="width: 100%; height: 100%; flex-shrink: 0;">
                                            <img src="{{ asset('uploads/' . $image) }}" alt="{{ $vehicle->name }}"
                        ...
                        <!-- Dots -->
                        @if(is_array($vehicle->images) && count($vehicle->images) > 1)
                            <div
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white line-clamp-1">{{ $vehicle->name }}
                            </h3>
                            <span
                        ...
                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-400 mb-3">
                            ...
                            <span class="truncate">{{ $vehicle->city }}</span>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            @if($vehicle->features)
                                ...
                                @if(count($vehicle->features) > 3)
                                    <span class="text-xs text-gray-500">+{{ count($vehicle->features) - 3 }} more</span>
                                @endif
                            @endif
                        </div>
