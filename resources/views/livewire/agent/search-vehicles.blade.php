        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold">{{ __('Search Vehicles') }}</h2>
                                    ...
                                    <div class="flex items-end justify-between">
                                        <div>
                                            ...
                                            <p class="text-xl font-bold text-green-600">Rs.
                                                {{ number_format($vehicle->daily_rate) }}</p>
                                            @if($vehicle->driver_fee)
                                                <p class="text-xs text-gray-500">+ Driver: Rs.
                                                    {{ number_format($vehicle->driver_fee) }}</p>
                                            @endif
                                        </div>
                                        <a href="https://wa.me/{{ str_replace(['+', ' ', '-'], '', $vehicle->user->phone ?? '') }}?text=Hi, I am interested in your vehicle: {{ $vehicle->name }}"
                                            target="_blank"
