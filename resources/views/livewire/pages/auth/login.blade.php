...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function login(): void
    {
        ...
        $url = match ($user->role) {
            ...
            'admin', 'operator' => route('admin.dashboard', absolute: false),
...
<div class="card p-4">
    <div class="text-center mb-6">
        <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-100">User Login</h4>
    </div>
    ...
    <form wire:submit="login">
        ...
        <div class="mb-4">
            <input wire:model="form.email" id="email"
                ...
                type="text" name="email" placeholder="Email or Phone Number" required autofocus
        ...
        <div class="mb-4">
            <div class="relative">
                <input wire:model="form.password" id="password"
                    class="block w-full px-4 py-3 pr-12 text-base border border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
        ...
        <button type="submit"
            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-4 rounded-md shadow transition duration-150 ease-in-out">
            {{ __('Log in') }}
        </button>
