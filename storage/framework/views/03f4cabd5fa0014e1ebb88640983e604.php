        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold"><?php echo e($page->exists ? 'Edit Page' : 'Create Page'); ?></h2>
                </div>
...
</div><?php /**PATH D:\laragon\www\Chaloo\resources\views/livewire/admin/page-form.blade.php ENDPATH**/ ?>