    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Rent a Vehicle</h1>
                    <div class="flex items-center mt-1">
                        <p class="text-gray-600 dark:text-gray-400 mr-2">Showing vehicles in <span
                ...
                <div class="w-full md:w-1/3">
                    <input type="text" wire:model.live="search" placeholder="🔍 Search car, model, city..."
                ...
                <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
                        <div class="text-center mb-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">Please enter your city to see available vehicles.
                            </p>
                        </div>
            ...
            <div x-data="{ showFilters: false }" class="mt-4">
                ...
                <div x-show="showFilters" x-transition
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Vehicle
                            Type</label>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="chaloo-slider relative">
                        <!-- Blue Dot Indicator for Company-Managed Vehicles -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehicle->is_company_managed): ?>
                            <div class="absolute top-3 left-3 z-10">
                                <div class="w-3 h-3 bg-blue-500 rounded-full shadow-lg animate-pulse" title="Company Managed"></div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white line-clamp-1"><?php echo e($vehicle->name); ?>

                            </h3>
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
                                <?php echo e($vehicle->type->name); ?>
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehicle->features): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_slice($vehicle->features, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span
                                        class="text-xs bg-gray-100 text-gray-800 px-2 py-1 rounded dark:bg-gray-700 dark:text-gray-300">
                                        <?php echo e($feature); ?>

                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($vehicle->features) > 3): ?>
                                    <span class="text-xs text-gray-500">+<?php echo e(count($vehicle->features) - 3); ?> more</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                            ...
                            <div class="flex items-end justify-between">
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-green-600">Rs.
                                        <?php echo e(number_format($vehicle->daily_rate)); ?>

                                    </p>
                                </div>
                                <a href="tel:<?php echo e($vehicle->user->phone); ?>"
                ...
                <div class="col-span-full text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$userCity): ?>
                            Please select a city to view vehicles
                        <?php else: ?>
                            No vehicles found in <?php echo e($userCity); ?>

                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </h3>
                    <p class="mt-1 text-sm text-gray-500">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$userCity): ?>
                            We optimize your experience by showing only relevant vehicles.
                        <?php else: ?>
...
</script><?php /**PATH D:\laragon\www\Chaloo\resources\views/livewire/public/browse-vehicles.blade.php ENDPATH**/ ?>