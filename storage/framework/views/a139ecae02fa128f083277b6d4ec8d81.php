...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Transporter Dashboard')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePackage && $activePackage->isActive()): ?>
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-white">
                        <h3 class="text-lg font-semibold mb-3">📦 Your Package: <?php echo e($activePackage->package->name ?? 'Custom Package'); ?></h3>
                        <div class="grid grid-cols-3 gap-4 text-sm">
                            <div>
                                <div class="text-blue-100">Listings</div>
                                <div class="text-2xl font-bold"><?php echo e($vehicleCount); ?> / <?php echo e($activePackage->listing_limit); ?></div>
                            </div>
                            <div>
                                <div class="text-blue-100">Days Left</div>
                                <div class="text-2xl font-bold"><?php echo e(max(0, now()->diffInDays($activePackage->expires_at, false))); ?></div>
                            </div>
                            <div>
                                <div class="text-blue-100">Expires On</div>
                                <div class="text-lg font-semibold"><?php echo e($activePackage->expires_at->format('d M Y')); ?></div>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehicleCount >= $activePackage->listing_limit): ?>
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(route('transporter.buy-packages')); ?>" class="inline-block bg-white text-blue-600 hover:bg-blue-50 font-bold py-2 px-4 rounded border border-white">
                                🔄 Upgrade Package
                            </a>
                        </div>
                    </div>
            ...
            <?php else: ?>
                <div class="bg-yellow-100 border-l-4 border-yellow-500 p-4">
                    ...
                    <a href="<?php echo e(route('transporter.buy-packages')); ?>" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                        📦 Buy Packages
                    </a>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-xl font-semibold mb-4"><?php echo e(__("Welcome back, Transporter!")); ?></h3>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1479919498-0', null);
...
<?php endif; ?><?php /**PATH D:\laragon\www\Chaloo\resources\views/transporter/dashboard.blade.php ENDPATH**/ ?>