        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold"><?php echo e(__('My Vehicles')); ?></h2>
                    <a href="<?php echo e(route('transporter.vehicles.create')); ?>"
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="py-2 px-4 border-b font-medium"><?php echo e($vehicle->name); ?></td>
                                    <td class="py-2 px-4 border-b"><?php echo e($vehicle->type->name ?? 'N/A'); ?></td>
                                    <td class="py-2 px-4 border-b"><?php echo e($vehicle->registration_number ?? '-'); ?></td>
                                    <td class="py-2 px-4 border-b">PKR <?php echo e(number_format($vehicle->daily_rate, 0)); ?></td>
                                    ...
                                    <td class="py-2 px-4 border-b">
                                        <a href="<?php echo e(route('transporter.vehicles.edit', $vehicle->id)); ?>"
...
</div><?php /**PATH D:\laragon\www\Chaloo\resources\views/livewire/transporter/vehicle-list.blade.php ENDPATH**/ ?>